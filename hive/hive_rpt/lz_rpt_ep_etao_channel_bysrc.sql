...
insert overwrite table lz_rpt_ep_etao_channel_bysrc partition (dt='${date}')
select
    '${date}' as day
    ,channel_id
    ,channel_src
...
(
    select
        ...
        ,refer_channel_src as channel_src
    ...
    where dt='${date}' and refer_is_channel_lp=1
    ...
    from lz_fact_ep_etao_channel_ownership 
    where dt='${date}' and channel_id > 0
) a
group by 
    channel_id
    ,channel_src
