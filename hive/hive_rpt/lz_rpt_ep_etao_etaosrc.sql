...
insert overwrite table lz_rpt_ep_etao_etaosrc partition (dt='${date}')
select
   day                                  
   ,src_domain_name                      
   ,lp_domain_name                       
...
select
    '${date}' as day
    ,src_domain_name_level2 as src_domain_name
