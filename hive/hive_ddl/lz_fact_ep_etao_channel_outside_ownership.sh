...
# Date:2012-10-22
# ------------------------------------------------------------------------
# Description: 由etao访问树和站外成交记录计算频道cookie+来源明细粒度的站外成交效果
...
$Hive <<EOF
drop table lz_fact_ep_etao_channel_outside_ownership;

create external table lz_fact_ep_etao_channel_outside_ownership
(
...
location '${hive_fact_dir}/lz_fact_ep_etao_channel_outside_ownership';
