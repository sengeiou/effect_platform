...
$Hive <<EOF
drop table lz_rpt_ep_etao_outside;

create external table lz_rpt_ep_etao_outside
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_outside';
alter table lz_rpt_ep_etao_outside set serdeproperties('serialization.null.format' = '');
