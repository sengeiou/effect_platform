...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao频道效果tmall来源明细报表
...
$Hive <<EOF
drop table lz_rpt_ep_etao_channel_tmallsrc;

create external table lz_rpt_ep_etao_channel_tmallsrc
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_tmallsrc';
alter table lz_rpt_ep_etao_channel_tmallsrc set serdeproperties('serialization.null.format' = '');
