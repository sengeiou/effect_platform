...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao效果-SEO来源明细报表
# Input: lz_fact_ep_etao_ownership
# Onput: lz_rpt_ep_etao_seo
# ------------------------------------------------------------------------
# ChangeLog:
##########################################################################

$Hive <<EOF
drop table lz_rpt_ep_etao_seo;

create external table lz_rpt_ep_etao_seo
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_seo';
alter table lz_rpt_ep_etao_seo set serdeproperties('serialization.null.format' = '');
