...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao效果-taobao来源明细报表
# Input: lz_fact_ep_etao_ownership
# Onput: lz_rpt_ep_etao_taobaosrc
# ------------------------------------------------------------------------
# ChangeLog:
##########################################################################

$Hive <<EOF
drop table lz_rpt_ep_etao_taobaosrc;

create external table lz_rpt_ep_etao_taobaosrc
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_taobaosrc';
alter table lz_rpt_ep_etao_taobaosrc set serdeproperties('serialization.null.format' = '');
