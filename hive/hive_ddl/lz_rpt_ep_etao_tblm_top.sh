...
$Hive <<EOF
drop table lz_rpt_ep_etao_tblm_top;
create external table lz_rpt_ep_etao_tblm_top
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_tblm_top';
alter table lz_rpt_ep_etao_tblm_top set serdeproperties('serialization.null.format' = '');
