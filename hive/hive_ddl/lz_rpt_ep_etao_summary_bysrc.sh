...
$Hive <<EOF
drop table lz_rpt_ep_etao_summary_bysrc;

create external table lz_rpt_ep_etao_summary_bysrc
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_summary_bysrc';
alter table lz_rpt_ep_etao_summary_bysrc set serdeproperties('serialization.null.format' = '');
