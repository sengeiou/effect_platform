...
$Hive <<EOF
drop table lz_rpt_ep_summary_bysrc;
create external table lz_rpt_ep_summary_bysrc 
(
...
stored as textfile
location '${hive_rpt_dir}/lz_rpt_ep_summary_bysrc'
;
alter table lz_rpt_ep_summary_bysrc set serdeproperties('serialization.null.format' = '');
EOF
