...
$Hive <<EOF
drop table lz_rpt_ep_etao_tbmarket_top;
create external table lz_rpt_ep_etao_tbmarket_top
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_tbmarket_top';
alter table lz_rpt_ep_etao_tbmarket_top set serdeproperties('serialization.null.format' = '');
