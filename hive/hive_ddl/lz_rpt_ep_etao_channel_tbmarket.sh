...
$Hive <<EOF
drop table lz_rpt_ep_etao_channel_tbmarket;

create external table lz_rpt_ep_etao_channel_tbmarket
(
   day                                  string comment '日期',
   channel_id                           bigint comment '频道id',
   tb_market_id                         string comment 'tb_market_id参数值',
   refer_site                           string comment 'refer二级域名',
   site_name                            string comment '网站名称',
   page_name                            string comment '页面名称',
   position_name                        string comment '位置名称',
   creative_name                        string comment '创意名称',
   activity_name                        string comment '活动名称',
   adid                                 string comment '活动id',
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_tbmarket';

alter table lz_rpt_ep_etao_channel_tbmarket set serdeproperties('serialization.null.format' = '');
EOF
