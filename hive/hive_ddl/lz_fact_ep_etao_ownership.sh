...
# Date:2012-10-22
# ------------------------------------------------------------------------
# Description: 汇总成交和流量效果，计算cookie+来源明细粒度的etao整体效果
...
$Hive <<EOF
drop table lz_fact_ep_etao_ownership;
create external table lz_fact_ep_etao_ownership
(
   ...
   is_etao                              bigint comment '是否etao访问',
...
location '${hive_fact_dir}/lz_fact_ep_etao_ownership';
