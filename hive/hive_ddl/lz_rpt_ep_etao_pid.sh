...
$Hive <<EOF
drop table lz_rpt_ep_etao_pid;

create external table lz_rpt_ep_etao_pid
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_pid';
alter table lz_rpt_ep_etao_pid set serdeproperties('serialization.null.format' = '');
