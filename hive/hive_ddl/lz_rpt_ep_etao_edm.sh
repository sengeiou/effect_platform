...
$Hive <<EOF
drop table lz_rpt_ep_etao_edm;

create external table lz_rpt_ep_etao_edm
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_edm';
alter table lz_rpt_ep_etao_edm set serdeproperties('serialization.null.format' = '');
