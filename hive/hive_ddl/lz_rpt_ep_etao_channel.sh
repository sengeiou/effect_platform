...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao频道效果汇总表
# Input: lz_fact_ep_etao_channel_ownership
# Onput: lz_rpt_ep_etao_channel
# ------------------------------------------------------------------------
# ChangeLog:
##########################################################################

$Hive <<EOF
drop table lz_rpt_ep_etao_channel;

create external table lz_rpt_ep_etao_channel
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel';
alter table lz_rpt_ep_etao_channel set serdeproperties('serialization.null.format' = '');
