...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao频道效果taobao来源明细报表
# Input: lz_fact_ep_etao_channel_ownership
# Onput: lz_rpt_ep_etao_channel_taobaosrc
# ------------------------------------------------------------------------
# ChangeLog:
##########################################################################

$Hive <<EOF
drop table lz_rpt_ep_etao_channel_taobaosrc;

create external table lz_rpt_ep_etao_channel_taobaosrc
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_taobaosrc';
alter table lz_rpt_ep_etao_channel_taobaosrc set serdeproperties('serialization.null.format' = '');
