...
$Hive <<EOF
drop table lz_rpt_ep_etao_tbmarket;

create external table lz_rpt_ep_etao_tbmarket
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_tbmarket';
alter table lz_rpt_ep_etao_tbmarket set serdeproperties('serialization.null.format' = '');
