...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao频道效果分来源汇总表
# Input: lz_fact_ep_etao_channel_ownership
# Onput: lz_rpt_ep_etao_channel_bysrc
# ------------------------------------------------------------------------
# ChangeLog:
##########################################################################

$Hive <<EOF
drop table lz_rpt_ep_etao_channel_bysrc;

create external table lz_rpt_ep_etao_channel_bysrc
(
   day                                  string comment '日期',
   channel_id                           bigint comment '频道id',
   channel_src                          bigint comment '访问来源',
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_bysrc';
alter table lz_rpt_ep_etao_channel_bysrc set serdeproperties('serialization.null.format' = '');
