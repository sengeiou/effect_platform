...
# Date:2012-10-22
# ------------------------------------------------------------------------
# Description: 由etao访问树和cps成交记录计算频道cookie+来源明细粒度的cps成交效果
...
$Hive <<EOF
drop table lz_fact_ep_etao_channel_cps_ownership;

create external table lz_fact_ep_etao_channel_cps_ownership
(
   ...
   source                       string comment '来源:1-亿起发。2-淘客。4-一淘联盟',
...
location '${hive_fact_dir}/lz_fact_ep_etao_channel_cps_ownership';
