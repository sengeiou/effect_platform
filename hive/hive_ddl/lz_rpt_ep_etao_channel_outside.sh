...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao频道效果站外自然流量明细报表
...
$Hive <<EOF
drop table lz_rpt_ep_etao_channel_outside;

create external table lz_rpt_ep_etao_channel_outside
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_outside';
alter table lz_rpt_ep_etao_channel_outside set serdeproperties('serialization.null.format' = '');
