...
$Hive <<EOF
drop table lz_rpt_ep_summary;
create external table lz_rpt_ep_summary 
(
...
stored as textfile
location '${hive_rpt_dir}/lz_rpt_ep_summary'
;
alter table lz_rpt_ep_summary set serdeproperties('serialization.null.format' = '');
EOF
