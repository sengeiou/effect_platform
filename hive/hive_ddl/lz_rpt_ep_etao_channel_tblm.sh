...
$Hive <<EOF
drop table lz_rpt_ep_etao_channel_tblm;

create external table lz_rpt_ep_etao_channel_tblm
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_tblm';
alter table lz_rpt_ep_etao_channel_tblm set serdeproperties('serialization.null.format' = '');
