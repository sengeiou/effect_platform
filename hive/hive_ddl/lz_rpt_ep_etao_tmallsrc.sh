...
# Date: 2012-11-21
# ------------------------------------------------------------------------
# Description: etao效果-tmall来源明细报表
# Input: lz_fact_ep_etao_ownership
# Onput: lz_rpt_ep_etao_tmallsrc
# ------------------------------------------------------------------------
# ChangeLog:
##########################################################################

$Hive <<EOF
drop table lz_rpt_ep_etao_tmallsrc;

create external table lz_rpt_ep_etao_tmallsrc
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_tmallsrc';
alter table lz_rpt_ep_etao_tmallsrc set serdeproperties('serialization.null.format' = '');
