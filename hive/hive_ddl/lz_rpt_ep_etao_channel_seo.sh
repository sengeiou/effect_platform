...
$Hive <<EOF
drop table lz_rpt_ep_etao_channel_seo;

create external table lz_rpt_ep_etao_channel_seo
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_channel_seo';
alter table lz_rpt_ep_etao_channel_seo set serdeproperties('serialization.null.format' = '');
