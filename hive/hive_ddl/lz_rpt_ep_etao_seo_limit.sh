...
$Hive <<EOF
drop table lz_rpt_ep_etao_seo_limit;

create external table lz_rpt_ep_etao_seo_limit
(
...
location '${hive_rpt_dir}/lz_rpt_ep_etao_seo_limit';
alter table lz_rpt_ep_etao_seo_limit set serdeproperties('serialization.null.format' = '');
